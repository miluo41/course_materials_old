...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while (not is_word_guessed(secret_word, letters_guessed)) and guesses_left>0:    
        ...
        while (not str.isalpha(guess)) and guesses_left>0:
            if warnings_left>0:
                warnings_left-=1
        ...
        while (guess in letters_guessed) and guesses_left>0:
            if warnings_left>0:
                warnings_left-=1
...
def match_with_gaps(my_word, other_word):
    ...
    trans2=str.maketrans('','','_')
    my_word=my_word.translate(trans1)
    my_word_letters=my_word.translate(trans2)
    ...
    for i in range(len(my_word)):
        if str.isalpha(my_word[i]):
            if my_word[i] != other_word[i]:
                return False
        elif other_word[i] in my_word_letters:
            return False
    return True
